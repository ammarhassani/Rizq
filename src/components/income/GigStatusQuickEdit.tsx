...
const STATUS_DOT: Record<string, string> = {
  paid: "bg-emerald-500", pending: "bg-amber-400", deposit_paid: "bg-amber-400",
  in_progress: "bg-blue-500", delivered: "bg-blue-500", overdue: "bg-red-500", cancelled: "bg-rizq-ink/30",
};
