    ...
    <div dir={dir} className={font}>
      {!confirming ? (
        <button
          ...
          className={`inline-flex items-center gap-2 rounded-full border border-red-300/50 text-red-600 px-6 py-3 text-sm font-medium hover:bg-red-50 transition-all ${font}`}
        >
          <Trash2 size={14} />
          {t("delete")}
        </button>
