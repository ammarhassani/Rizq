    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          disabled={isPending}
          onClick={() => run("reject")}
          className={`inline-flex items-center gap-2 rounded-full border border-[var(--over-line)] text-[var(--over)] hover:bg-[var(--over-soft)] px-4 py-2 text-sm transition-colors disabled:opacity-60 ${font}`}
        >
